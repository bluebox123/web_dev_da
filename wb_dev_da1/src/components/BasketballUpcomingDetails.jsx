...
import "./BasketballUpcomingDetails.css";

const BasketballUpcomingDetails = () => {
  ...
  useEffect(() => {
    console.log(`Fetching details for upcoming basketball match ID: ${matchId}`);
  ...
  return (
    <div className="match-details-container">
      <h1>Upcoming Basketball Match Details</h1>
      {match ? (
...
export default BasketballUpcomingDetails; // Ensure this is a default export