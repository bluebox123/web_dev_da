...
import "./BasketballOngoingDetails.css";

const BasketballOngoingDetails = () => {
  ...
  const currentDate = new Date("2023-10-15T19:00:00"); // Set to a specific date and time with ongoing matches

  useEffect(() => {
    console.log(`Fetching details for ongoing basketball match ID: ${matchId}`);
  ...
  return (
    <div className="match-details-container">
      <h1>Ongoing Basketball Match Details</h1>
      {match ? (
...
export default BasketballOngoingDetails; // Ensure this is a default export